...
class TableLayouts:
    ...
    #     """
    #
    def showReport(self, s_date, e_date):
        ...
        result = self.DBSnowflake.run_query(sql)
        # st.write(sql)
        ...
        AgGrid(result, gridOptions=options, custom_css=(css), allow_unsafe_jscode=True)
